...
def train():
    ...
    if len(files) > 1:
        ...
        agent0.save_model("../ludo_rl_bot_v1_data/saved_models/model_" + dt_string + ".hdf5")
        agent0.save_model('../ludo_rl_bot_v1_data/saved_models/current_model.hdf5')

        requests.post("http://ludo-rl-bot-v1.rgu.network:3000/load_model", json={'path': '../ludo_rl_bot_v1_data/saved_models/current_model.hdf5'})
